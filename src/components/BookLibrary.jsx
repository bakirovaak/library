  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="fixed top-6 right-6 z-50 p-4 bg-white/20 backdrop-blur-xl border border-white/30 rounded-full shadow-2xl hover:scale-110 transition-all"
      >
        {darkMode ? <Sun className="w-6 h-6 text-orange-300" /> : <Moon className="w-6 h-6 text-amber-100" />}
      </button>
